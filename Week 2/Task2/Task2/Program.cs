...
namespace Task2
{
    class Program
    {
        ...
        { 
            string[] s = System.IO.File.ReadAllText(@"C:\Users\Админ\Desktop\pp2\Week 2\Task2\in.txt").Split();//Read numbers from file and split spaces
            ...
            System.IO.File.WriteAllText(@"C:\Users\Админ\Desktop\pp2\Week 2\Task2\out.txt", r);// storing output in another file
        }
    }
}
